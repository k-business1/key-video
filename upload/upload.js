  ...
  return new Promise((resolve, reject)=>{
    ...
    xhr.onerror = function(){
      if(window.location.protocol === "file:"){
        ...
        reject(new Error("Network error reaching Cloudinary — check for an ad-blocker/VPN blocking api.cloudinary.com, or that this domain is allowed in your Cloudinary account's Security settings"));
      }
    };
    xhr.send(fd);
  });
